...
//                             $.ajax({
//                                    type:"POST",
//			            url:"$baseUrl;<?php// echo '?>'; ?>/product/returnProductForm",
//			           data:  {
//				         "id" :id,
...
//                                              },
//			                beforeSend : function(){
//                                               $("#<?php// echo $this->modelClass; ?>::ADMIN_TREE_CONTAINER_ID'; ?>").addClass("ajax-sending");
//                                                               },
//                                        complete : function(){
//                                              $("#::ADMIN_TREE_CONTAINER_ID<?php// echo ';?>'; ?>").removeClass("ajax-sending");
//                                                             },
//                                       success: function(data){
//                                        $.fancybox(data,
//                            {  "transitionIn"	:	"elastic",
