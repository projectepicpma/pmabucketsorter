...
class FilterController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','delete','updateFilterString','returnForm','updateActive'),
				'users'=>array('@'),
			),
	...
	public function actionUpdateFilterString()
	{
		if(isset($_POST['Filter']))
		{
			$model = Filter::model()->findByPk($_POST['Filter']['id']);
			if($model===null){
	...
	/**
	* Activates or Deactivates a particular model.
	* If deletion is successful, the browser will be redirected to the 'admin' page.
	* @param integer $id the ID of the model to be deleted
	*/
